        ...
        switch(index){
            ...
            case 19:
                $.layer({
                    ...
                    border: [0],
                    shade : [0.9, '#000'],
                    iframe: {src: '../../../im.qq.com/online/flash/flash20140304.swf'}
                });
            break;
            case 20:
                $.layer({
        ...
        case 'tab':
            ...
            layer.tab({
                ...
                data: [{
                    ...
                    title: 'Belite主题', 
                    content: tabIframe('../../../www.belite.mobi')
                }, {
                    title: '后台主题', 
...
window.paysentsin = function(){
    return $.layer({
        ...
        page: {html: '<img src="../../../res.sentsin.com/images/pay.png">'},
        shadeClose: true
    });
};
...
var juan = function(){
    var i = $.layer({
        ...
        area: ['620px','auto'],
        page: {
            html: '<div class="juan"><p>从2012年6月6号发布</p><p>至今</p><p>layer已经服务于十余万家web平台</p><p>并还在迅速增长</p><p>她已然成为众多开发人员的非常常用的前端组件。</p><p>必须感谢这些年来那些关注和使用layer的数以万计的人们</p><p>感谢所有群友的支持与陪伴</p><p class="juanmove">正是善良的你们</p><p>让原本早就想放弃的layer变得超乎寻常的生命力</p><p>也催发了我开发layui的决定</p><p>如果你喜欢layer，可以用实际行动来支持她。</p><p>您可购买layer的版权（可用于一切商业用途）或者赞助，layer感恩无限。</p><p>layer仍在继续, 使命仍然在继续,我们仍在继续…</p><p style="text-align:right;">——贤心</p><p style="padding-top:10px;font-size:0; text-align:center;"><a href="../../../item.taobao.com/item.htm@id=37295654589" target="_blank" class="juanGo">去授权</a><a href="javascript:;" class="juanGo" id="paysentsin">赞助</a><a href="javascript:;" class="juanLu">路过</a></p></div>'
        }, success: function(){
            layer.shift('top', 500);
    ...
    if(!layer.xinyuanIframe){
        var i = $.layer({
            ...
            success:function(layerDom){
                ...
                layer.tips('该许愿墙亦由layer实现，传送的愿望将会在<a href="../../default.htm" style="color:#c00" target="_blank">博客首页</a>展现', '#xinyuan',5);
            }, end: function(){
...
conf.postmsg = function(){
    //获取下载数
    if($('#downs')[0]){
        $.post('../../../sentsin.com/item/filedown.asp@action=hits&id=3957', function(datas){
    ...
    //获取关注次数
    $.post('../../../sentsin.com/item/GetHits.asp@Action=Count&GetFlag=0&m=113&ID=41', function(datas){
        var downloads = datas.match(/\d+/)[0];
        $('#sees').html(downloads);
    });
