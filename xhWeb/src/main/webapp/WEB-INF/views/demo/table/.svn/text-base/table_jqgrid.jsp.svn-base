...
<li class="active">
    ...
    <ul class="nav nav-second-level">
        ...
        <li class="active"><a href="table_jqgrid.html">jqGrid</a>
        </li>
    </ul>
</li>
<li>
            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        <p>
                            <strong>jqGrid</strong> 是一个用来显示网格数据的jQuery插件，文档比较全面，附带中文版本。访问<a target="_blank" href="../../../www.trirand.com/blog/default.htm"> 官网</a>
                        </p>
                        <p>jqGrid的主要特点为：</p>
                        <ol>
...
<!-- Peity 图表插件-->
<!--<script src="${rs}/js/plugins/peity/jquery.peity.min.js"></script>-->
...
$(document).ready(function () {
    ...
    $("#table_list_2").jqGrid({
        url:'${ctx}/demo/table/findDataByJqgrid',
        datatype: "json",
        height: 450,
        autowidth: true,
        shrinkToFit: true,
