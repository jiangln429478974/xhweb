							...
							<div class="col-md-7">
	                          ...
	                          <div class="form-actions"> 
										...
										<div class="col-md-offset-0 col-md-5">
											...
											<button type="button"  class="btn blue" id="btn-sx"> 筛选A </button>
											<button type="button"  class="btn blue" id="btn-bgx">不更新 </button>
										</div>
									</div>
							 </div>	
...
/*--------------------------分割线----------------------------------------------  */  
   ...
   //批量删除用户
    ...
    $('#btn-sx').click(function () {
		window.location.href = "${ctx}/zljk/gozlyc";
    }); 
	
	
    //跳到根据日期找出不更新部门
    $('#btn-bgx').click(function () {
		window.location.href = "${ctx}/zljk/gozlpl";
    }); 
