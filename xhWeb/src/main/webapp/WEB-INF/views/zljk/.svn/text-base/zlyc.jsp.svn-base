...
<!-- 								</a> -->
							...
							<div class="col-md-7">
	                          ...
	                          <div class="form-actions"> 
										...
										<div class="col-md-offset-0 col-md-5">
											...
											<a href="${ctx}/zljk/sxlist"><button class="btn btn-warning" id="reset" type="button"><i class="fa fa-refresh"></i> 刷 新 </button></a>
											<a href="${ctx}/zljk/list"><button class="btn btn-warning" id="reset" type="button"><i class="fa fa-refresh"></i> 返回</button></a>
										</div>
									</div>
							 </div>	
     ...
     <div class="row">
				<div class="col-md-6" style="width:100%">
					<div class="portlet box blue">
						<div class="portlet-title">
							<div style="color:#F00" class="caption">
								异常数据交换列表
							</div>
...
/*--------------------------列表---分割线----------------------------------------------  */  
	...
	$.ajax({
		...
		success:function(data){
			...
			var rowStr = "<tr><th style=\"width:100px;color:#F00\">部门名称</th><th style=\"width:500px;color:#F00\">中文表名称</th><th style=\"width:200px;color:#F00\">表名称</th><th style=\"width:200px;color:#F00\">UNID</th>";
			for (var i=0; i<data.length; i++){
				...
				if(rowObj.UNID!=null){
					rowStr += "<td>"+rowObj.BMMC+"</td>"+"<td>"+rowObj.GXMLMC+"</td>"+"<td>"+rowObj.TNAME+"</td>"+"<td>"+rowObj.UNID+"</td>"
	rowStr += "</tr>";
				}else{
					rowStr += "<td>"+rowObj.BMMC+"</td>"+"<td>"+rowObj.GXMLMC+"</td>"+"<td>"+rowObj.TNAME+"</td>"+"<td>"+" "+"</td>"
	rowStr += "</tr>";
				}
