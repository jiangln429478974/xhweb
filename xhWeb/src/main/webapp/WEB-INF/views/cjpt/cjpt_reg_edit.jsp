...
<rapid:override name="title">添加订单</rapid:override>
							...
							<div class="portlet light form-groupd">
								...
								<div class="portlet-title">
									<input type="hidden" id="taskid" value="${task.ID}">
                                        ...
                                        <div class="zyr_name" id="res_name">${task.RESNAME}</div>
								...
								<div class="portlet-body">
									<ul class="nav nav-tabs">
										...
										<a href="#tab_1_1" data-toggle="tab">
												资源选择 </a></li>
										<!-- <li><a href="#tab_1_2" data-toggle="tab"> 共享设置 </a></li> -->
									...
									<div class="tab-content">
										<div class="tab-pane fade active in" id="tab_1_1">
											<div class="btn-group m-b5">
												...
												<c:forEach var="resource" items="${task.RES_LIST}">
										...
										<div class="tab-pane fade" id="tab_1_2">
											...
											<div class="mb_5">
												<input type="text" placeholder="资源名称"
													class="form-control input-inline" style="width: 160px;">
									...
									<div class="form-body">
										...
										<div class="form-group">
													...
													<div class="checkbox-list">
															...
															<input type="checkbox" id="ccc" value="option1" checked="checked" disabled> 平台web接口</label>
															<label class="checkbox-inline">
											...
											<div class="col-md-8">
												<div class="btn-group">
													...
													<select id="frequencySel" data-style="btn-default" class="selectpicker">
															...
															<c:forEach var="frequency" items="${task.FREQUENCY_LIST}">
										...
										<div class="form-group">
											...
											<div class="col-md-8">
												...
												<textarea id="message" class="form-control"
													placeholder="请填写资源描述" rows="7">${task.DESCRIPTION}</textarea>
...
<rapid:override name="page_script">
	<script>
		$(document).ready(function() {
			$('#ccc').click();
			var res_id = "${task.RES_ID}";
			$("#ResIdSel").val(res_id);
			var frequencyid = "${task.FREQUENCY}";
			$("#frequencySel").val(frequencyid);
			var setting = {
	 	    		async : {
	 	    			enable : true,
	 	    			url : "${ctx}/cjpt/" + res_id + "/datalist/fieldTree",
		...
		function commitBtn() {
			...
			var tagDate = $("#tagDiv").tags().tagData;
			//var array = tagDate.split(",");
			...
			layer.confirm('是否提交？', {
				...
				$.ajax({
					url : '${ctx}/cjpt/datalist/editdata/edit',
					type : "POST",
					data : {
						"ID" : taskid,
						"RES_ID" : resid,
						...
						"FREQUENCY" : FREQUENCY,
						"RESOURCE_NAME_CN" : res_name,
						"RESOURCE_DESCRIPTION" : res_description
					},
					dataType : "json"
				 ...
				 $("#tagDiv").tags(
							{
								...
								tagData : [],
								afterDeletingTag : function(tagData){
									layer.confirm('是否删除标签？', {
										btn : [ '确定', '取消' ],
										shade : false
									}, function() {
										$.ajax({
											url : '${ctx}/cjpt/editdata/tag/delete',
											type : "POST",
											data : {
												"res_id" : resid,
												"tag" :tagData
							...
							beforeAddingTag : function(tagData){
								layer.confirm('是否提交标签？', {
									btn : [ '确定', '取消' ],
									shade : false
								}, function() {
									$.ajax({
										url : '${ctx}/cjpt/editdata/tag/add',
										type : "POST",
										data : {
											"res_id" : resid,
											"tag" :tagData
